...
public class MainSwipeActivityNonvegBreakfastdiet1 extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        for(Profile profile : UtilsNonvegBreakfastDiet1.loadProfiles(this.getApplicationContext())){
