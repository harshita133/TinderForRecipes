...
import com.developer.harshi.tinderforrecipes.MainSwipeVegDinner1;
...
public class CuisinesActivityVegDinner extends AppCompatActivity {
            ...
            if(i==0){
                ((TextView)view.findViewById(R.id.tvAddCuisine)).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                       // Toast.makeText(CuisinesActivityVegDinner.this,"Data to be Added",Toast.LENGTH_SHORT).show();
                        Intent i = new Intent(CuisinesActivityVegDinner.this, MainSwipeVegDinner1.class);
                        startActivity(i);
                    }
                });}
            if(i==1){
