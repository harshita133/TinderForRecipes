...
public class DietActivityNonvegLunch extends AppCompatActivity {
            ...
            if(i==0){
                ((TextView)view.findViewById(R.id.tvAddDietVariant)).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Toast.makeText(DietActivityNonvegLunch.this,"Data to be Added",Toast.LENGTH_SHORT).show();
                        Intent i = new Intent(DietActivityNonvegLunch.this, MainSwipeNonvegLunch1.class);
                        startActivity(i);
                    }
                });}
            if(i==1){
