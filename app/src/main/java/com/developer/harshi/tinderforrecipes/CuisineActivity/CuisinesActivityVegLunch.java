...
import com.developer.harshi.tinderforrecipes.MainSwipeVegLunch1;
import com.developer.harshi.tinderforrecipes.MainSwipeVegLunch3;
...
public class CuisinesActivityVegLunch extends AppCompatActivity {
...
//           View itemView= li.inflate(R.layout.list_item_course,null);
            ...
            if(i==0){
                ((TextView)view.findViewById(R.id.tvAddCuisine)).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                       // Toast.makeText(CuisinesActivityVegLunch.this,"Data to be Added",Toast.LENGTH_SHORT).show();
                        Intent i = new Intent(CuisinesActivityVegLunch.this, MainSwipeVegLunch1.class);
                        startActivity(i);
                    }
                });}
            if(i==1){
            ...
            if(i==2){
                ((TextView)view.findViewById(R.id.tvAddCuisine)).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        //Toast.makeText(CuisinesActivityVegLunch.this,"Data to be Added",Toast.LENGTH_SHORT).show();
                        Intent i = new Intent(CuisinesActivityVegLunch.this, MainSwipeVegLunch3.class);
                        startActivity(i);
                    }
                });}
            if(i==3){
