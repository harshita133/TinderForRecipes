...
public class CuisinesActivityNonvegBreakfast extends AppCompatActivity {
            ...
            if(i==0){
                ((TextView)view.findViewById(R.id.tvAddCuisine)).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        //Toast.makeText(CuisinesActivityNonvegBreakfast.this,"Data to be Added",Toast.LENGTH_SHORT).show();
                        Intent i = new Intent(CuisinesActivityNonvegBreakfast.this, MainSwipeActivityNonvegBreakfastdiet1.class);
                        startActivity(i);
                    }
                });}
            if(i==1){
