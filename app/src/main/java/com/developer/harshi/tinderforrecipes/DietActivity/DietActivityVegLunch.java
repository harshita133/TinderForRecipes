...
public class DietActivityVegLunch extends AppCompatActivity {
            ...
            if(i==0){
                ((TextView)view.findViewById(R.id.tvAddDietVariant)).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Toast.makeText(DietActivityVegLunch.this,"Data to be Added",Toast.LENGTH_SHORT).show();
//
                    }
                });}
            if(i==1){
//                ((TextView)view.findViewById(R.id.tvAddDietVariant)).setBackgroundResource(R.drawable.lowsugar);
                ((TextView)view.findViewById(R.id.tvAddDietVariant)).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Toast.makeText(DietActivityVegLunch.this,"Data to be Added",Toast.LENGTH_SHORT).show();
