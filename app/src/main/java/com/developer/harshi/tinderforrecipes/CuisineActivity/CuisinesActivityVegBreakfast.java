...
import com.developer.harshi.tinderforrecipes.MainSwipeVegBreakfast1;
...
public class CuisinesActivityVegBreakfast extends AppCompatActivity {
            ...
            if(i==0){
                ((TextView)view.findViewById(R.id.tvAddCuisine)).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                       // Toast.makeText(CuisinesActivityVegBreakfast.this,"Data to be Added",Toast.LENGTH_SHORT).show();
                        Intent i = new Intent(CuisinesActivityVegBreakfast.this, MainSwipeVegBreakfast1.class);
                        startActivity(i);
                    }
                });}
            if(i==1){
