...
import com.developer.harshi.tinderforrecipes.MainSwipeNonvegLunch1;
...
public class CuisinesActivityNonvegLunch extends AppCompatActivity {
            ...
            if(i==0){
                ((TextView)view.findViewById(R.id.tvAddCuisine)).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        //Toast.makeText(CuisinesActivityNonvegLunch.this,"Data to be Added",Toast.LENGTH_SHORT).show();
                        Intent i = new Intent(CuisinesActivityNonvegLunch.this, MainSwipeNonvegLunch1.class);
                        startActivity(i);
                    }
                });}
            if(i==1){
